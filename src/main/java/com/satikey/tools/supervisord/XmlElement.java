...
/**
 * An xml element within an xml tree. In this case an xml element can have a text content OR a
 * multiple amount of children. The xml element itself has a name.
 *
 * @author Tim Roes
 * @see https://github.com/gturri/aXMLRPC/blob/master/src/main/java/de/timroes/axmlrpc/xmlcreator/XmlElement.java
 */
public class XmlElement {
    ...
    /**
     * Set the content of this xml tag. If the content is set the children won't be used in a string
     * representation.
     *
